...
import com.google.api.services.authorizedbuyersmarketplace.v1.model.PreferredDealTerms;
 ...
 *
 * <p>This will modify the deal's flightStartTime, flightEndTime, and preferredDealTerms.
 *
...
public class PatchPreferredDeals {
  ...
  public static void execute(AuthorizedBuyersMarketplace marketplaceClient, Namespace parsedArgs) {
    ...
    patchedPreferredDeal.setProposalRevision(proposalRevision);
    ...
    patchedPreferredDeal.setFlightStartTime(startTime.toString(ISODateTimeFormat.dateTime()));
    patchedPreferredDeal.setFlightEndTime(endTime.toString(ISODateTimeFormat.dateTime()));
    ...
    PreferredDealTerms preferredDealTerms = new PreferredDealTerms();
    preferredDealTerms.setFixedPrice(fixedPrice);
    patchedPreferredDeal.setPreferredDealTerms(preferredDealTerms);

    String updateMask =
        "flightStartTime,flightEndTime,"
            + "preferredDealTerms.fixedPrice.amount.units,preferredDealTerms.fixedPrice.amount.nanos";
    ...
    try {
      deal =
          marketplaceClient
              ...
              .proposals()
              .deals()
              .patch(name, patchedPreferredDeal)
  ...
  public static void main(String[] args) {
    ArgumentParser parser =
        ArgumentParsers.newFor("PatchPreferredDeals")
            .build()
            .defaultHelp(true)
            .description(("Patches a preferred deal at the given revision number."));
    parser
    ...
    parser
        ...
        .help("Number of nano units of the currency specified for the preferred deal.")
        .type(Integer.class)
