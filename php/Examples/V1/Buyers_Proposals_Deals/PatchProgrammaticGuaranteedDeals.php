 ...
 *
 * This will modify the deal's flightStartTime, flightEndTime, and programmaticGuaranteedDealTerms.
 *
 ...
 */
class PatchProgrammaticGuaranteedDeals extends BaseExample
{
    ...
    public function run()
    {
        ...
        $programmaticGuaranteedDealTerms = new ProgrammaticGuaranteedTerms();
        $programmaticGuaranteedDealTerms->fixedPrice = $fixedPrice;
        ...
        $patchedDeal->programmaticGuaranteedTerms = $programmaticGuaranteedDealTerms;
    ...
    {
        return 'Patch Programmatic Guaranteed Deals';
    }
}
