...
{
    /// <summary>
    /// Resume serving of a given finalized deal.
    ///
    /// Note that only programmatic guaranteed deals can be resumed by buyers at this time.
    /// </summary>
    public class ResumeFinalizedDeals : ExampleBase
    {
        ...
        {
            get => "This code example resumes serving of a given finalized deal.";
        }
        ...
        protected override Dictionary<string, object> ParseArguments(List<string> exampleArgs) {
            ...
            OptionSet options = new OptionSet {
                "Resumes serving of a given finalized deal.",
                {
                    "h|help",
                ...
                },
                {
                    ...
                    ("[Required] The resource ID of the buyers resource under which the " +
                     ...
                     "as a path parameter for the finalizedDeals.resume request."),
                    a => accountId = a
                },
                {
                    "d|deal_id=",
        ...
        protected override void Run(Dictionary<string, object> parsedArgs)
        {
            ...
            BuyersResource.FinalizedDealsResource.ResumeRequest request =
                mkService.Buyers.FinalizedDeals.Resume(new ResumeFinalizedDealRequest(), name);
            FinalizedDeal response = null;

            Console.WriteLine("Resuming a finalized deal with name: {0}", name);
