...
def main(marketplace, args):
    ...
    print(f'Get deal with name "{deal_name}":')
    try:
        # Construct and execute the request.
        response = marketplace.buyers().proposals().deals().get(
            name=deal_name).execute()
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description=('Get a deal for the given buyer account, proposal, and '
                     'deal IDs.'))
    # Required fields.
    parser.add_argument(
