 ...
 *
 * <p>The publisher will be sent an RFP that will initiate negotiation for a preferred deal. For the
 ...
 */
public class SendRfpForPreferredDealProposals {
  ...
  public static void execute(AuthorizedBuyersMarketplace marketplaceClient, Namespace parsedArgs) {
    ...
    rfp.setPreferredDealTerms(preferredDealTerms);
    ...
    System.out.printf("Sending preferred deal RFP for buyer Account ID '%d':%n", accountId);
    Utils.printProposal(proposal);
  }

  public static void main(String[] args) {
    ArgumentParser parser =
        ArgumentParsers.newFor("SendRfpForPreferredDealProposals")
            .build()
            .defaultHelp(true)
            .description(
                ("Sends a request for proposal for a preferred deal to a publisher for the "
    ...
    parser
        ...
        .type(String.class)
        .setDefault(String.format("Test PD Proposal %s", UUID.randomUUID()));
