...
use Google\Service\AuthorizedBuyersMarketplace\ProgrammaticGuaranteedTerms;
use Google\Service\AuthorizedBuyersMarketplace\Price;
use Google\Service\AuthorizedBuyersMarketplace\SendRfpRequest;

/**
 * This example illustrates how to send a request for proposal to a publisher for a programmatic
 * guaranteed deal.
 *
 * The publisher will be sent an RFP that will initiate negotiation for a programmatic guaranteed
 ...
 */
class SendRfpForProgrammaticGuaranteedDealProposals extends BaseExample
{
    ...
    protected function getInputParameters()
    {
        return [
            ...
            [
                ...
                'required' => false,
                'default' => 'Test PG Proposal #' . uniqid()
            ]
        ];
    }
    ...
    public function run()
    {
        ...
        $rfp->note = 'Test programmatic guaranteed deal proposal created by PHP sample.';
        ...
        $programmaticGuaranteedTerms->guaranteedLooks = 0;
        $programmaticGuaranteedTerms->minimumDailyLooks = 0;
        $programmaticGuaranteedTerms->reservationType = 'STANDARD';
        $programmaticGuaranteedTerms->impressionCap = 0;
        $programmaticGuaranteedTerms->percentShareOfVoice = 0;
        $programmaticGuaranteedTerms->fixedPrice = $fixedPrice;
        $rfp->programmaticGuaranteedTerms = $programmaticGuaranteedTerms;

        print "<h2>Sending programmatic guaranteed deal RFP to '$publisherProfileName' on " .
              "behalf of '$parentName':</h2>";
    ...
    {
        return 'Send RFP for Programmatic Guaranteed Deal Proposal';
    }
}
