 ...
 * Authorized Buyers Marketplace API samples to run.
 */

use Google\Ads\AuthorizedBuyers\Marketplace\ExampleUtil\Config;
use function Google\Ads\AuthorizedBuyers\Marketplace\HtmlHelper\printExamplesIndex;
use function Google\Ads\AuthorizedBuyers\Marketplace\HtmlHelper\printHtmlFooter;
use function Google\Ads\AuthorizedBuyers\Marketplace\HtmlHelper\printHtmlHeader;
use function Google\Ads\AuthorizedBuyers\Marketplace\HtmlHelper\printSampleHtmlFooter;
...
if ($client->getAccessToken()) {
    ...
    $service = Config::getGoogleServiceAuthorizedBuyersMarketplace($client);
    ...
    if (isset($exampleClass)) {
        ...
        printHtmlHeader('Marketplace API PHP usage examples.');
