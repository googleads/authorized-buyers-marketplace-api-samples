...
/**
 * This example shows how to delete a client user with the given account, client, and user IDs.
 *
 * Note that this is intended to completely disassociate a given client user from a client. As a
 * result, the email associated with the client user will lose access to the Authorized Buyers UI
 * once it is deleted. To restore access, create and activate a new client user using the same
 * email address.
 */
class DeleteClientUsers extends BaseExample
{
        ...
        return [
            ...
            [
                ...
                'description' =>
                    ...
                    'was created. This will be used to construct the name used as a path parameter ' .
                    'for the users.delete request.',
                'required' => true
            ],
             [
                ...
                'description' =>
                    ...
                    'deleted. This will be used to construct the name used as a path parameter ' .
                    'for the users.delete request.'
            ]
        ];
    }
    ...
    public function run()
    {
        ...
        try {
            $result = $this->service->buyers_clients_users->delete($name);
            print "<h2>Deleting client user '$name' was successful!</h2>";
            $this->printResult($result);
        } catch (GoogleServiceException $ex) {
            print "<h2>Deleting client user '$name' was unsuccessful.</h2>";
