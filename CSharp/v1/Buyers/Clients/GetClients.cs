...
{
    /// <summary>
    /// Gets a single client for the given buyer account ID and client ID.
    /// </summary>
    public class GetClients : ExampleBase
    {
        ...
        {
            get => "This code example gets a specific client for a buyer account.";
        }
        ...
        protected override Dictionary<string, object> ParseArguments(List<string> exampleArgs) {
            ...
            OptionSet options = new OptionSet {
                "Get a client for a given buyer account ID and client ID.",
                {
                    "h|help",
                ...
                },
                {
                    ...
                    ("[Required] The resource ID of the buyers.clients resource for which the " +
                     ...
                     "path parameter for the clients.get request."),
                    c => clientId = c
                },
            };
        ...
        protected override void Run(Dictionary<string, object> parsedArgs)
        {
            ...
            BuyersResource.ClientsResource.GetRequest request =
                mkService.Buyers.Clients.Get(name);
            Client response = null;

            Console.WriteLine("Getting client with name: {0}", name);
