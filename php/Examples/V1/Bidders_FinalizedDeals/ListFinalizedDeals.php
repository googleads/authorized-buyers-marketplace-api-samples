...
namespace Google\Ads\AuthorizedBuyers\Marketplace\Examples\V1\Bidders_FinalizedDeals;
...
/**
 * This example illustrates how to list finalized deals for the given bidder, their buyers, and
 * clients.
 */
class ListFinalizedDeals extends BaseExample
{
    ...
    protected function getInputParameters()
    {
        return [
            [
                ...
                'required' => true,
                'description' =>
                    'The resource ID of the bidders resource for which the finalized deals are ' .
    ...
    public function run()
    {
        ...
        $result = $this->service->bidders_finalizedDeals->listBiddersFinalizedDeals(
            $parentName,
            $queryParams
        );
