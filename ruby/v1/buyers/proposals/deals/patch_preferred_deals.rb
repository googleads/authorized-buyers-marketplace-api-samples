...
def patch_preferred_deals(marketplace, options)
  ...
  update_mask = 'flightStartTime,flightEndTime,preferredDealTerms.fixedPrice.amount.units,'\
...
if __FILE__ == $0
  ...
  begin
    patch_preferred_deals(service, opts)
